                                                                ...
                                                                <div class="custom-dropdown-group">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                            <a class="dropdown-item" href="{{route('employee.garage.restore' , $vehicle->id)}}">Restore</a>
                                                                            <a class="dropdown-item" href="{{route('employee.garage.forceDelete' , $vehicle->id)}}">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
