                ...
                <div class="row gutters">
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="t-header">Aid Reciept Campaign Table </div>
																...
																<div class="custom-dropdown-group">
																	<div class="dropdown">
																		...
																		<div class="dropdown-menu"
																			...
																			<form method="get" action="{{ route('employe.storeKeeper.aidReceiving.aid', $AidRecieptCampaign->id) }}">
																				@csrf
																				<button class="dropdown-item" type="submit">Show Aid Details</button>
																			</form>
																		</div>
																	</div>
																</div>
