        ...
        <div class="page-content">
            ...
            <div class="main-container">
                ...
                <div class="page-header">
                    ...
                    <!-- Breadcrumb start -->
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Create Distribution Campaigns</li>
                    </ol>
                    <!-- Breadcrumb end -->
                ...
                <div class="row gutters">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <form action="{{ route('admin.AidDistributionCampaigns.store.aidDistributionCampaigns') }}" method="POST" id="locationForm">
                                @csrf
                                <div id="initialForm">
                                    <div class="card-body">
                                        <div class="row gutters">
                                ...
                                @foreach ($aidIDs as $aidID)
                                    <input type="hidden" name="aidIDs[]" value="{{ $aidID }}">
                                @endforeach
