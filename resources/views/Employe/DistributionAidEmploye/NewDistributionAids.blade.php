                        ...
                        <div class="table-container">
                            ...
                            <div class="table-responsive">
                                <table id="basicExample" class="table custom-table">
                                    ...
                                    <tbody>
                                        @foreach ($newDistributionAids as $AidDistributionCampaign)
                                            <tr>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="{{ route('employe.distributionAid.aidDistributionCampaigns.aid', $AidDistributionCampaign->id) }}">
                                                                                Show Aid Details
                                                                            </a>
                                                                            <form method="post" action="{{ route('employe.distributionAid.aidDistributionCampaigns.aid.accept.delivery.all', $AidDistributionCampaign->id) }}" style="display: inline;">
                                                                                @csrf
                                                                                @method('put')
                                                                                <button class="dropdown-item" type="submit">Accept Delivery All Aid</button>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                </div>
