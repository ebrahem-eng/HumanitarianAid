<nav id="sidebar" class="sidebar-wrapper">
    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-menu">
            <ul>
                <li class="active">
                    <a href="{{ route('employe.distributionAid.index') }}" class="current-page">
                ...
                <li class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu">
                        <ul>
                            <li>
                                <a href="{{ route ('employe.distributionAid.aidDistributionCampaigns.new')}}">New Distribution Aid</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu">
                        <ul>
                            <li>
                                <a href="{{ route ('employe.distributionAid.association.new.request')}}">New Association Request Table</a>
                            </li>

                            <li>
                                <a href="{{ route ('employe.distributionAid.association.history.request')}}">Association Request History</a>
                            </li>
                        </ul>
                    </div>
                </li>
