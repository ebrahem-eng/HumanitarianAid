                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            ...
                            <a href="donors.html" class="dropdown-item">Donors</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Non profit charity website.</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>Damascus, Syria</p>
                    <p><i class="fa fa-phone-alt me-3"></i>+0123 456 789</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Feel free to inquire regarding any question you have in mind.</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a href="#">Charity</a>, All Right Reserved.
                    </div>
