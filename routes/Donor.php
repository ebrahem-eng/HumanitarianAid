...
Route::get('donor/edit_profile/{id}', [AuthController::class, 'edit_profile'])->name('donor.edit_profile');

Route::put('donor/update/{id}', [AuthController::class, 'update'])->name('donor.update');
