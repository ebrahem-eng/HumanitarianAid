                ...
                <div class="row gutters">
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="t-header">History Reconnaissance Tours Table </div>
                            <div class="table-responsive">
                                <table id="basicExample" class="table custom-table">
                                    ...
                                    <tbody>
                                        @foreach ($historyReconnaissanceEmployes as $historyReconnaissanceEmploye)
                                            <tr>
                                                <td>{{ $historyReconnaissanceEmploye->name }}</td>
                                                <td>{{ $historyReconnaissanceEmploye->date }}</td>
                                                <td>{{ $historyReconnaissanceEmploye->startTime }}</td>
                                                <td>{{ $historyReconnaissanceEmploye->endTime }}</td>
                                                <td>{{ $historyReconnaissanceEmploye->priority }}</td>
                                                <td>{{ $historyReconnaissanceEmploye->note }}</td>
                                                <td>
                                                    @foreach ($historyReconnaissanceEmploye->ReconnaissanceToursEmployee as $ReconnaissanceToursEmployee)
                                                ...
                                                <td>
                                                    @foreach ($historyReconnaissanceEmploye->ReconnaissanceToursVehicle as $ReconnaissanceToursVehicle)
                                                ...
                                                <td>
                                                    @foreach ($historyReconnaissanceEmploye->ReconnaissanceTourLocation as $ReconnaissanceTourLocation)
                                                        {{ $ReconnaissanceTourLocation->address }} -
                                                        {{ $ReconnaissanceTourLocation->street }}
                                                    @endforeach
                                                </td>
                                                <td>
                                                    @if ($historyReconnaissanceEmploye->status == 1)
                                                ...
                                                <td>{{ $historyReconnaissanceEmploye->reasonOfRefuse }}</td>
                                                <td>{{ $historyReconnaissanceEmploye->admin->name }}</td>
                                                <td>{{ $historyReconnaissanceEmploye->created_at }}</td>
