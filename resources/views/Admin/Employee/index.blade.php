                                        ...
                                        <tr>
                                            ...
                                            <td>
												...
												@elseif ($employee->type == 3)	
												    Warehouse guard
												@elseif ($employee->type == 4)
												    Garage manager
												@elseif ($employee->type == 5)
                                                                ...
                                                                <div class="custom-dropdown-group">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                            ...
                                                                            <a class="dropdown-item" href="{{route('admin.employee.changePassword.page' , $employee->id)}}">Change Password</a>
                                                                            <a class="dropdown-item" href="{{route('admin.employee.soft.delete' , $employee->id)}}">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
