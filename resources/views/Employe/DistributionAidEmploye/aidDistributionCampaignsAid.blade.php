                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="table-responsive">
                                <table id="basicExample" class="table custom-table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Receipt From Store Keeper Status</th>
                                    ...
                                    <tbody>
                                        @foreach ($aidForaidDistributionCampaigns as $aidForaidDistributionCampaign)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($aidForaidDistributionCampaign->ReceiptFromStoreKeeperStatus == 0)
                                                        <div class="btn btn-primary">
                                                            Pending Receipt
                                                        </div>
                                                    @elseif($aidForaidDistributionCampaign->ReceiptFromStoreKeeperStatus == 1)
                                                        <div class="btn btn-success">
                                                            Receipted
                                                        </div>
                                                    @endif
                                                ...
                                                <td>
                                                    @if (
                                                        $aidForaidDistributionCampaign->StatusReceiptStoreKeeper == 1 &&
                                                        $aidForaidDistributionCampaign->AidDeliveryStatus == 0 &&
                                                        $aidForaidDistributionCampaign->ReceiptFromStoreKeeperStatus == 1
                                                    )
                                                        <div class="row gutters">
                                                            <div class="col-sm-12">
                                                                <div class="card-body">
                                                                    <div class="custom-dropdown-group">
                                                                        <div class="dropdown">
                                                                            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton-{{ $aidForaidDistributionCampaign->id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                                Action
                                                                            </button>
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton-{{ $aidForaidDistributionCampaign->id }}">
                                                                                <form method="post" action="{{ route('employe.distributionAid.aidDistributionCampaigns.aid.accept.delivery', $aidForaidDistributionCampaign->id) }}">
                                                                                    @csrf
                                                                                    @method('put')
                                                                                    <input type="hidden" name="aidDistributionCampaignsID" value="{{ $aidDistributionCampaignsID }}" />
                                                                                    <button class="dropdown-item" type="submit">Accept Delivery</button>
                                                                                </form>
                                                                                <button class="dropdown-item" type="button" onclick="showReturnForm({{ $aidForaidDistributionCampaign->id }})">Return Aid</button>
                                                                            </div>
                                                
                                                                            <!-- Return Form (hidden by default) -->
                                                                            <form id="return-form-{{ $aidForaidDistributionCampaign->id }}" method="post" action="{{ route('employe.distributionAid.aidDistributionCampaigns.aid.return.aid', $aidForaidDistributionCampaign->id) }}" style="display: none; margin-top: 10px;">
                                                                                @csrf
                                                                                @method('put')
                                                                                <input type="hidden" name="aidDistributionCampaignsID" value="{{ $aidDistributionCampaignsID }}" />
                                                                                <div class="form-group">
                                                                                    <input type="number" class="form-control" name="returnedQuantity" placeholder="Returned Quantity" required />
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <input style="width: 170px" type="text" class="form-control" name="ReasonForReturn" placeholder="Reason for Return" required />
                                                                                </div>
                                                                                <button class="btn btn-danger" type="submit">Submit Return</button>
                                                                            </form>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="custom-dropdown-group">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton-{{ $aidForaidDistributionCampaign->id }}">
                                                                                <form method="post" action="{{ route('employe.distributionAid.aidDistributionCampaigns.aid.accept.receipt', $aidForaidDistributionCampaign->id) }}">
                                                                                    @csrf
                                                                                    @method('put')
                                                                                    <button class="dropdown-item" type="submit">Accept Receipt From Store Keeper</button>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    @if($aidForaidDistributionCampaign->ReceiptFromStoreKeeperStatus == 1)
                                                    <!-- Additional Button Section -->
                                                    <button class="btn btn-secondary" type="button" onclick="showDeliveryForm({{ $aidForaidDistributionCampaign->id }})">Delivery To Association</button>
                                                
                                                    <!-- Delivery Form (hidden by default) -->
                                                    <form id="delivery-form-{{ $aidForaidDistributionCampaign->id }}" method="post" action="{{ route('employe.distributionAid.aidDistributionCampaigns.aid.delivery.association', $aidForaidDistributionCampaign->id) }}" style="display: none; margin-top: 10px;">
                                                        @csrf
                                                        <input type="hidden" name="aidDistributionCampaignsID" value="{{ $aidDistributionCampaignsID }}" />
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input style="width: 170px" type="text" class="form-control" name="note" placeholder="Note" required />
                                                        </div>
                                                        <div class="form-group">
                                                            <select class="form-control" name="associationID" required>
                                                        ...
                                                        <button class="btn btn-success" type="submit">Submit Delivery</button>
                                                    </form>
                                                @endif
                                                
                                                <script>
                                                    function showDeliveryForm(id) {
                                                        var form = document.getElementById('delivery-form-' + id);
                                ...
                                <script>
                                    function showReturnForm(aidId) {
                                        document.getElementById('dropdownMenuButton-' + aidId).style.display = 'none';
                                        document.getElementById('return-form-' + aidId).style.display = 'block';
                                    }
                                </script>
