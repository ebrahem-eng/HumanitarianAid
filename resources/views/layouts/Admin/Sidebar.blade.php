            ...
            <ul>
                ...
                <li class="sidebar-dropdown">
                    <a href="#">
                        ...
                        <span class="menu-text">Aid Distribution Campaigns Manage</span>
                    </a>
                    <div class="sidebar-submenu">
                        <ul>
                            <li>
                                <a href="{{ route('admin.AidDistributionCampaigns.index') }}">Aid Distribution Campaigns
                                    Table</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.AidDistributionCampaigns.create') }}">Create Aid Distribution Campaigns</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.AidDistributionCampaigns.archive') }}">Aid Distribution Campaigns
                                    Archive</a>
                            </li>
