                ...
                <div class="row gutters">
                    <div class="col-sm-12">
                        ...
                        <div class="table-container">
                            ...
                            <div class="t-header">Aid Distribution Campaign Archive Table</div>
                                    ...
                                    <tbody>
                                        @foreach ($AidDistributionCampaigns as $AidDistributionCampaign)
                                            <tr>
                                                ...
                                                <td>{{ $AidDistributionCampaign->deleted_at }}</td>
												<td>
													<div class="row gutters">
														<div class="col-sm-12">
															<div class="card-body">
																	...
																	<div class="dropdown">
																		...
																		<div class="dropdown-menu"
																			...
																			<a class="dropdown-item"
																				href="{{ route('admin.AidDistributionCampaigns.restore', $AidDistributionCampaign->id) }}">Restore</a>
																			<form method="post" action="{{ route('admin.AidDistributionCampaigns.forceDelete', $AidDistributionCampaign->id) }}">
																				@csrf
																				@method('delete')
