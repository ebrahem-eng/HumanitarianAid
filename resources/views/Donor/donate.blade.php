...
<body>
                    ...
                    <div class="h-100 bg-secondary p-5">
                        ...
                        <div id="moneyPopup" class="popup-form" style="display: none; margin-top: 3%;">
                            ...
                            <div class="form-floating mt-2">
                                <select class="form-select" id="paymentWay" name="">
                            ...
                            <div id="medicalPopup" class="popup-form" style="display: none; margin-top: 3%;">
                                <div class="form-floating">
                                    <input type="text" class="form-control bg-light border-0"
                                        placeholder="Enter name" id="medicalName" name="name">
                                    <label for="medicalName">Enter name</label>
                                </div>
                                <div class="form-floating" style="margin-top: 3%;">
                                    <input type="number" class="form-control bg-light border-0"
                                        placeholder="Enter quantity" id="medicalQuantity" name="quantity">
                        ...
                        <div id="foodPopup" class="popup-form" style="display: none; margin-top: 3%;">
                            <div class="form-floating">
                                <input type="text" class="form-control bg-light border-0"
                                    placeholder="Enter food item" id="foodItem" name="name">
                                <label for="foodItem">Enter food item</label>
                            </div>
                            <div class="form-floating mt-2">
                                <input type="number" class="form-control bg-light border-0"
                                    placeholder="Enter quantity" id="foodQuantity" name="quantity">
                                <label for="foodQuantity">Enter quantity</label>
                            </div>
                            <div class="form-floating">
                                <select class="form-select bg-light border-0" id="foodBoxSize" name="boxSize">
                                    <option value="" disabled selected>Select Box Size</option>
                                    <option value="small">Small</option>
                                    <option value="larg">Middle</option>
                                    <option value="xlarg">Big</option>
                                </select>
                                <label for="foodBoxsize">Select Box Size</label>
                            </div>
                            <div class="form-floating mt-2">
                                <input type="date" class="form-control bg-light border-0"
                                    placeholder="Enter expiration" id="foodExpiration" name="expiration">
                                <label for="foodExpiration">Enter Expiration</label>
                            </div>
                        ...
                        <form method="post" action="{{ route('donor.donate.clothing') }}">
                            ...
                            <div id="clothesPopup" class="popup-form" style="display: none; margin-top: 3%;">
                                ...
                                <div class="form-floating" style="margin-top: 3%;">
                                    ...
                                    <label for="clothesAmount">Enter Quantity</label>
                                </div>
                                <div class="form-floating" style="margin-top: 3%;">
                                    <input type="number" class="form-control bg-light border-0"
                                        placeholder="Enter age" id="clothesAge" name="age">
    ...
    <script>
        ...
        function addFoodItem() {
            ...
            var boxSize = document.getElementById("foodBoxSize").value;
            var expiration = document.getElementById("foodExpiration").value
